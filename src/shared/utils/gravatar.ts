...
/**
 * Simple MD5 hash implementation for email addresses
...
function md5(str: string): string {
  ...
  if (typeof crypto !== 'undefined' && crypto.subtle) {
    // This is async, but we'll use a sync fallback for now
    // In practice, Gravatar URLs should be generated server-side
  }

  // Fallback: simple MD5 implementation
  // This is a simplified version - in production, consider using a proper crypto library
  return simpleMd5(str);
}

/**
 * Simplified MD5 implementation
 * Note: This is a basic implementation. For production use with Node.js,
 * consider using the 'crypto' module instead.
 */
